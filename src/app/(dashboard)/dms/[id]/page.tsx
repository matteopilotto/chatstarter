...
function ImagePreview({
  ...
  return (
    <div className="relative size-40 overflow-hidden rounded-lg border group">
      <Image
      ...
      <Button
        type="button"
        className="absolute top-2 right-2 group-hover:opacity-80 opacity-0 transition-opacity"
        size="icon"
        variant="destructive"
        onClick={onDelete}
      >
